...
AI Coding Assistant 是一款本地优先、面向真实软件工程项目的 VS Code AI 编程助手。0.9 版本提供可缓存项目画像、规划确认到执行闭环、回复安全重试、代码片段送审、Agent 受控测试工具、统一任务时间线、多模型路由、统一权限和任务检查点。
...
```powershell
code --install-extension .\artifacts\ai-coding-assistant-0.9.0.vsix --force
```
