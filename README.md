...
AI Coding Assistant 是一款本地优先、面向真实软件工程项目的 VS Code AI 编程助手。0.10 版本在项目画像、规划确认、Agent 受控验证和安全变更闭环基础上，新增可恢复的变更检查点、会话归档、首次使用向导和脱敏诊断。
...
```powershell
code --install-extension .\artifacts\ai-coding-assistant-0.10.0.vsix --force
```
