...
AI Coding Assistant 是一款本地优先、面向真实软件工程项目的 VS Code AI 编程助手。0.8 版本提供可缓存项目画像、规划确认到执行闭环、回复安全重试、本地代码高亮与代码片段送审、统一任务时间线、多模型路由、统一权限、任务检查点和受控测试执行。
...
```powershell
code --install-extension .\artifacts\ai-coding-assistant-0.8.0.vsix --force
```
